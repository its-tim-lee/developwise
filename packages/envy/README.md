![Envy hero image](./assets/images/logo.png)
...
- [Setup](./setup.md): how to add Envy to a project for the first time

- [Concepts](./concepts.md): why Envy does not use Vite mode as the application environment, how `APP_ENV` works, and how validation/type generation fit together.
